...
// import RecommendItem from '../../../../pawpaw/app/components/Recommend/RecommendItem';
...
//   const fetchPostsByClassName = async (labelName, l) => {
...
//     //     .limit(l)
//     //     .get();
//     //   const postList: RecommendPost[] = post.docs
//     //     .map(x => ({
//     //       ...(x.data() as Post),
//     //       className: labelName,
//     //     }))
...
//         numColumns={3}
//         data={posts}
//         renderItem={({item, index}) => <RecommendItem {...{item, index}} />}
